...
public class db_reg_phar extends AsyncTask<String,Void,String> {
    Context context;
    AlertDialog alertDialog;

    db_reg_phar(Context ctx) {
    ...
    protected String doInBackground(String... params) {
        ...
        String register_url = "http://asuratest1996.000webhostapp.com/jeevan/ph_register.php";
        ...
        if (type.equals("register")) {
            try {
                ...
                String post_data = URLEncoder.encode("spname", "UTF-8") + "=" + URLEncoder.encode(name, "UTF-8") + "&"
